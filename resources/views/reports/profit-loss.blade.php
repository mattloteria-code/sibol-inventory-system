...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-2xl font-bold">Profit $ Loss Report</h1>
    @include('reports._export-buttons', ['routeName' => 'reports.profit-loss'])
</div>

@include('reports._date-filter', ['routeName' => 'reports.profit-loss'])
...
<div class="grid grid-cols-6 gap-4 mb-6">
    ...
    <div class="bg-white rounded-lg shadow p-4">
        ...
        <p class="text-xl font-bold text-amber-700">₱{{ number_format($summary['outstanding_amount'], 2) }}</p>
    </div>
</div>
