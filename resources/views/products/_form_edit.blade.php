    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" value="{{ $product->stock_quantity }}" disabled
                   class="w-full border border-gray-200 bg-gray-100 text-gray-500 rounded-lg px-3 py-2">
            <p class="text-xs text-gray-400 mt-1">Adjust stock via Inventory → Restock (coming soon).</p>
        </div>
